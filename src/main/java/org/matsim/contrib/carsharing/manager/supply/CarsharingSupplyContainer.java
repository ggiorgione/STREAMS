...
implements CarsharingSupplyInterface {
	...
	public CarsharingSupplyContainer(Scenario scenario, String path) {
		this.scenario = scenario;
		this.path = path;
	}
	...
	public void populateSupply() {
		...
		reader.readFile(this.path + configGroup.getvehiclelocations());
